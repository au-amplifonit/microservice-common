...
namespace Fox.Microservices.Common
{
	public class Startup : BaseStartup
	{
		...
		public override void ConfigureServices(IServiceCollection services)
		{
			...
			{
				c.SwaggerDoc("v1", new Info { Title = "FOX Microservices - Common API", Version = "v1" });
				var filePath = Path.Combine(System.AppContext.BaseDirectory, "Fox.Microservices.Common.xml");
